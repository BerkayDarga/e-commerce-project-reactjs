...
import SmallBanners from './Home-Page-Components/SmallBanners'
...
import Products from './Home-Page-Components/Products'
...
import Banners from './Home-Page-Components/Banners'
...
import DiscountProducts from './Home-Page-Components/DiscountProducts'
...
import Banner2 from './Home-Page-Components/Banner2'
...
const Home = () => {
    return (
        <div className="">
            ...
            <SmallBanners earPhone={EarPhone} playstationArm={img36} macBook={computer} playStation={playstation} />
            ...
            <div className="bannercontainer">
                <Banners photo={banners1} title="Popular Products" bannerdescription="iPad combines a magnificent 10.2-inch Retina display, incredible performance, multitasking and ease of use." />
                <Banners photo={banners3} title="Ipad Pro" bannerdescription="iPad combines a magnificent 10.2-inch Retina display, incredible performance, multitasking and ease of use." />
                <Banners photo={banners2} title="Samsung Galaxy" bannerdescription="iPad combines a magnificent 10.2-inch Retina display, incredible performance, multitasking and ease of use." />
                <Banners photo={banners4} title="Macbook Pro" bannerdescription="iPad combines a magnificent 10.2-inch Retina display, incredible performance, multitasking and ease of use." />
            </div>
